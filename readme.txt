...
* Fixed plugin, ip2long was returning negative numbers on 32bit platforms
  preventing plugin from fetching appropriate country information.

= 1.0.3 =
* Fixed plugin, removed old unrelated debug message on cancel order in woocommerce.
